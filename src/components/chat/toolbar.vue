<template>
  <div id="toolbar">
    ...
    <div id="btnBar">
      <div class="topBtnBar">
        <el-tooltip class="item" effect="dark" content="智能问答" placement="right">
          <el-button @click="chooseChatList('小智')" class="toolBtn" size="small"><i class="fa fa-android fa-2x" aria-hidden="true"></i></el-button>
        </el-tooltip>
      </div>
